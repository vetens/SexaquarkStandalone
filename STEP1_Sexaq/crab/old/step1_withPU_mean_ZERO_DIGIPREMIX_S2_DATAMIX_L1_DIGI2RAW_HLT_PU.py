...
# with command line options: step1_with_pileup_mix_2016_25ns_Moriond17MC_PoissonOOTPU_noPreMix.py --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step DIGI,L1,DIGI2RAW,HLT:@frozen2016 --nThreads 8 --era Run2_2016 --filein file:step-1.root --fileout file:step0.root --no_exec --pileup 2016_25ns_Moriond17MC_PoissonOOTPU
...
process.load('SimGeneral.MixingModule.mix_2016_25ns_Moriond17MC_PoissonOOTPU_MODIFIEDJARNEFORLOWPU_cfi')
...
#    annotation = cms.untracked.string('step1_with_pileup_mix_2016_25ns_Moriond17MC_PoissonOOTPU_noPreMix.py nevts:1'),
