...
class FlatTreeProducerGENSIM : public edm::EDAnalyzer
 {
  ...
  private:
    ...
    std::vector<float> _GEN_Ks_daughter0_vx,_GEN_Ks_daughter0_vy,_GEN_Ks_daughter0_vz,_GEN_Ks_daughter0_lxy,_GEN_Ks_daughter0_lxy_zero,_GEN_Ks_daughter0_dxy,_GEN_Ks_daughter0_dz,_GEN_Ks_daughter0_openings_angle_displacement_momentum;
    ...
    std::vector<float> _GEN_AntiLambda_AntiProton_vx,_GEN_AntiLambda_AntiProton_vy,_GEN_AntiLambda_AntiProton_vz,_GEN_AntiLambda_AntiProton_lxy,_GEN_AntiLambda_AntiProton_lxy_zero,_GEN_AntiLambda_AntiProton_dxy,_GEN_AntiLambda_AntiProton_dz,_GEN_AntiLambda_AntiProton_openings_angle_displacement_momentum;
