...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
    'dcap://maite.iihe.ac.be/pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/Step1/Sexaquark_13TeV_trial7_Vtx_smeared/SUS-RunIISummer16DR80Premix-00068_step1_IIDD.root',
  ),
