...
process.source = cms.Source("PoolSource",
  fileNames = cms.untracked.vstring(
	'file:/pnfs/iihe/cms/store/user/jdeclerc/crmc_Sexaq/Step1/CRAB_SimSexaq_7000Step1InputFiles/crab_Step1Sexaq_19042019_v3/190419_121537/0000/output_326.root'
  ),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('test_V0RecoAntiSV0s.root'),
...
process.AODSIMoutput.outputCommands += ("keep *_genParticlesPlusGEANT_*_*",)
# Other statements
