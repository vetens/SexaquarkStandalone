...
print("input argument: "+str(sys.argv[2]))
print("output argument: "+str(sys.argv[3]))
...
#    fileNames = cms.untracked.vstring(str(sys.argv[2])), 
...
#    fileName = cms.untracked.string(str(sys.argv[3])),
